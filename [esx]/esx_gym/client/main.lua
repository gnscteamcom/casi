...
function OpenGymShopMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_shop_menu',
        {
            title    = 'Gym - Shop',
            elements = {
				{label = 'Batido de proteinas ($350)', value = 'protein_shake'},
				{label = 'Agua ($300)', value = 'water'},
				{label = 'Comida deportiva ($300)', value = 'sportlunch'},
				{label = 'Powerade ($300)', value = 'powerade'},
				{label = 'Vendaje ($5000)', value = 'bandage'},
            }
        },
        function(data, menu)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'bike_menu',
        {
            ...
            elements = {
				...
				{label = 'Scorcher ($100)', value = 'scorcher'},
            }
        },
        function(data, menu)
