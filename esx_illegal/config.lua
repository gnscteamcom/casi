...
Config.CircleZones = {
	...
	WeedProcessing = {coords = vector3(1035.86, -3205.20, -38.17), name = _U('blip_weedprocessing'), color = 25, sprite = 496, radius = 100.0},
	...
	HeroinProcessing = {coords = vector3(-62.15, 6391.40, 31.49), name = _U('blip_heroinprocessing'), color = 25, sprite = 496, radius = 100.0},
